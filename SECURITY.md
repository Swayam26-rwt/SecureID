...
National Highways Authority of India (NHAI) Datalake 3.0 Biometrics prioritizes data privacy and edge security. If you discover a vulnerability or security issue within this offline biometric pipeline, please report it responsibly.

### Disclosure Process
1. **Do not create public GitHub issues** for security vulnerabilities.
2. Email your findings directly to the repository maintainer or NHAI security team.
3. Include:
